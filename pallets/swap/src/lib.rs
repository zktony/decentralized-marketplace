...
pub mod pallet {
	...
	pub trait Config<I: 'static = ()>: frame_system::Config {
		...
		/// module
		type Assets: Transfer<Self::AccountId, AssetId = CurrencyId, Balance = u128>
			+ Inspect<Self::AccountId, AssetId = CurrencyId, Balance = u128>
			+ Mutate<Self::AccountId, AssetId = CurrencyId, Balance = u128>;
